        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bio = table.Column<string>(type: "nvarchar(3096)", maxLength: 3096, nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Artists",
                columns: new[] { "Id", "Bio", "ImagePath", "Name" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), null, null, "Unknown" });
